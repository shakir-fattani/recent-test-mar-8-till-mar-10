...
from enterprise_computer_use.tools.claude import EditTool
from enterprise_computer_use.tools.collection import ToolCollection
from enterprise_computer_use.tools.computer import BashTool, ComputerTool
...
@Registry.register(OSType.LINUX, ProjectType.COMPUTER_USE)
def _():
    """Register the Linux computer use project with the registry."""
    return Config(
