...
@Registry.register(OSType.LINUX, ProjectType.CONCUR_COMPUTER_USE)
def _():
    """Register the Linux concur computer use project with the registry."""
    return Config(
        tool_collection=ToolCollection(
            ComputerTool(), BashTool(), EditTool(), AnyParserTool()
        ),
